...
void dodajPoprawna(BazaTestu *wskBazaTestu){
  wskBazaTestu->PoprawnychOdp+=1;
}

void pokazStatystyki(BazaTestu Baza){
  cout<<"Ilosc pytan: "<<Baza.IloscPytan<<endl;
  cout<<"Poprawnych odpowiedzi: "<<Baza.PoprawnychOdp<<endl;
  cout<<"Blednych odpowiedzi: "<<Baza.IloscPytan-Baza.PoprawnychOdp<<endl;
  cout<<"Procent poprawnych odpowiedzi: "<<(Baza.PoprawnychOdp*100)/Baza.IloscPytan<<"%"<<endl;
}